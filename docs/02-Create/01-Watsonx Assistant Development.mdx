...
1. Import an actions JSON file to Watsonx Assistant
   - On the Actions page of watsonx Assistant, click on Global Settings.
   - On the Upload/Download tab, click the Upload button and upload the file that was given to you by your IBM teachers.
